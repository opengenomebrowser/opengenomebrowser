...
select [`Open genome info`](https://opengenomebrowser.bioinformatics.unibe.ch/genome/FAM18356-i1-1.1/).
  ...
  - Files associated to this genome such as the assembly, coding sequences or annotation files can be downloaded 
    using the links located at the bottom of the page.
